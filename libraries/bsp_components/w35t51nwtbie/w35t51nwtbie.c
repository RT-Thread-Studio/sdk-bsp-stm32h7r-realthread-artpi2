...
/** @defgroup W35T51NWTBIE W35T51NWTBIE
  * @{
  */
...
//   {
//     if (W35T51NWTBIE_ReadCfgRegister(Ctx, Mode, Rate, &reg[1]) != W35T51NWTBIE_OK)
//     {
//       return W35T51NWTBIE_ERROR;
//     }
//   }
...
//                                 : HAL_XSPI_INSTRUCTION_16_BITS;
//  s_command.Instruction        = (Mode == W35T51NWTBIE_SPI_MODE)
//                                 ? W35T51NWTBIE_WRITE_CFG_REG2_CMD
//                                 : W35T51NWTBIE_OCTA_WRITE_CFG_REG2_CMD;
//  s_command.AddressMode        = (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_ADDRESS_1_LINE : HAL_XSPI_ADDRESS_8_LINES;
//  s_command.AddressDTRMode     = (Rate == W35T51NWTBIE_DTR_TRANSFER)
//                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
//                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
...
//                                 : HAL_XSPI_DATA_DTR_DISABLE;
//  s_command.DummyCycles        = 0U;
//  s_command.DataLength             = (Mode == W35T51NWTBIE_SPI_MODE) ? 1U : ((Rate == W35T51NWTBIE_DTR_TRANSFER) ? 2U : 1U);
//  s_command.DQSMode            = HAL_XSPI_DQS_DISABLE;
//#if defined (XSPI_CCR_SIOO)
//  s_command.SIOOMode            = HAL_XSPI_SIOO_INST_EVERY_CMD;
//#endif
...
//                                 : HAL_XSPI_INSTRUCTION_16_BITS;
//  s_command.Instruction        = (Mode == W35T51NWTBIE_SPI_MODE)
//                                 ? W35T51NWTBIE_READ_CFG_REG2_CMD
//                                 : W35T51NWTBIE_OCTA_READ_CFG_REG2_CMD;
//  s_command.AddressMode        = (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_ADDRESS_1_LINE : HAL_XSPI_ADDRESS_8_LINES;
//  s_command.AddressDTRMode     = (Rate == W35T51NWTBIE_DTR_TRANSFER)
//                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
//                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
...
//                                 : HAL_XSPI_INSTRUCTION_16_BITS;
//  s_command.Instruction        = (Mode == W35T51NWTBIE_SPI_MODE)
//                                 ? W35T51NWTBIE_WRITE_SECURITY_REG_CMD
//                                 : W35T51NWTBIE_OCTA_WRITE_SECURITY_REG_CMD;
//  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
//  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
//  s_command.DataMode           = HAL_XSPI_DATA_NONE;
//  s_command.DummyCycles        = 0U;
...
//                                 : HAL_XSPI_INSTRUCTION_16_BITS;
//  s_command.Instruction        = (Mode == W35T51NWTBIE_SPI_MODE)
//                                 ? W35T51NWTBIE_READ_SECURITY_REG_CMD
//                                 : W35T51NWTBIE_OCTA_READ_SECURITY_REG_CMD;
//  s_command.AddressMode        = (Mode == W35T51NWTBIE_SPI_MODE) ? HAL_XSPI_ADDRESS_NONE : HAL_XSPI_ADDRESS_8_LINES;
//  s_command.AddressDTRMode     = (Rate == W35T51NWTBIE_DTR_TRANSFER)
//                                 ? HAL_XSPI_ADDRESS_DTR_ENABLE
//                                 : HAL_XSPI_ADDRESS_DTR_DISABLE;
...
//                                 ? HAL_XSPI_INSTRUCTION_8_BITS
//                                 : HAL_XSPI_INSTRUCTION_16_BITS;
//  s_command.Instruction        = (Mode == W35T51NWTBIE_SPI_MODE) ? W35T51NWTBIE_NOP_CMD : W35T51NWTBIE_OCTA_NOP_CMD;
//  s_command.AddressMode        = HAL_XSPI_ADDRESS_NONE;
//  s_command.AlternateBytesMode = HAL_XSPI_ALT_BYTES_NONE;
//  s_command.DataMode           = HAL_XSPI_DATA_NONE;
//  s_command.DummyCycles        = 0U;
