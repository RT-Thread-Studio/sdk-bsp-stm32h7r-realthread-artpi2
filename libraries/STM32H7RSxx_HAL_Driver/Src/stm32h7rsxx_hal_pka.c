...
void HAL_PKA_IRQHandler(PKA_HandleTypeDef *hpka)
{
  ...
  uint32_t addErritsource = __HAL_PKA_GET_IT_SOURCE(hpka, PKA_IT_ADDRERR);
  uint32_t ramErritsource = __HAL_PKA_GET_IT_SOURCE(hpka, PKA_IT_RAMERR);
  uint32_t opErritsource = __HAL_PKA_GET_IT_SOURCE(hpka, PKA_FLAG_OPERR);
  uint32_t procEnditsource = __HAL_PKA_GET_IT_SOURCE(hpka, PKA_IT_PROCEND);
  ...
  if ((addErritsource == SET) && (addErrFlag == SET))
  {
  ...
  if ((ramErritsource == SET) && (ramErrFlag == SET))
  {
  ...
  if ((opErritsource == SET) && (operErrFlag == SET))
  {
  ...
  if ((procEnditsource == SET) && (procEndFlag == SET))
  {
    /* Clear PROCEND flag */
