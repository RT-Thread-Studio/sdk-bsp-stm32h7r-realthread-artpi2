...
#define LL_RCC_SWP_XSPI1_RECOVERY          RCC_CKPROTR_XSPI1SWP_2
/**
  * @}
  */
...
#define LL_RCC_SWP_XSPI2_RECOVERY          RCC_CKPROTR_XSPI2SWP_2
/**
  * @}
  */
...
#define LL_RCC_SWP_FMC_RECOVERY            (RCC_CKPROTR_FMCSWP_2 | RCC_CKPROTR_FMCSWP_0)
/**
  * @}
  */
...
/**
  ...
  *         @arg @ref LL_RCC_SWP_XSPI2_NEUTRAL
            ...
            @arg @ref LL_RCC_SWP_XSPI2_RECOVERY
  */
...
/**
  ...
  *         @arg @ref LL_RCC_SWP_XSPI1_NEUTRAL
            ...
            @arg @ref LL_RCC_SWP_XSPI1_RECOVERY
  */
...
/**
  ...
  *         @arg @ref LL_RCC_SWP_FMC_NEUTRAL
            ...
            @arg @ref LL_RCC_SWP_FMC_RECOVERY
  */
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_RCC_CalcPLLClockFreq(uint32_t PLLInputFreq, uint32_t M, uint32_t N, uint32_t FRACN, uint32_t PQR)
{
  float_t freq;
