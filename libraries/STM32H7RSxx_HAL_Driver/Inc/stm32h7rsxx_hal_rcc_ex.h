...
/** @defgroup RCCEx_TIM_Prescaler_Selection TIM Prescaler Selection
  * @{
  */
#define RCC_TIMPRES_DESACTIVATED   0U                         /*!< Timers clocks prescaler not set (default) */
#define RCC_TIMPRES_ACTIVATED      RCC_CFGR_TIMPRE            /*!< Timers clocks prescaler set */
...
/** @defgroup RCCEx_CRS_SynchroSource CRS SynchroSource
  * @{
  */
#define RCC_CRS_SYNC_SOURCE_PIN          0U                                      /*!< Synchro Signal source GPIO */
...
/** @brief  Macro to get the FMC clock source.
  ...
  *            @arg RCC_FMCCLKSOURCE_HSI   HSI selected as FMC clock
  */
#define __HAL_RCC_GET_FMC_SOURCE() ((uint32_t)(READ_BIT(RCC->CCIPR1, RCC_CCIPR1_FMCSEL)))
...
/** @brief  Macro to get the XSPI1 clock source.
  ...
  *            @arg RCC_XSPI1CLKSOURCE_PLL2T PLL2_T Clock selected as XSPI1 clock
  */
#define __HAL_RCC_GET_XSPI1_SOURCE() ((uint32_t)(READ_BIT(RCC->CCIPR1, RCC_CCIPR1_XSPI1SEL)))
...
/** @brief  Macro to get the XSPI2 clock source.
  ...
  *            @arg RCC_XSPI2CLKSOURCE_PLL2T PLL2_T Clock selected as XSPI2 clock
  */
#define __HAL_RCC_GET_XSPI2_SOURCE() ((uint32_t)(READ_BIT(RCC->CCIPR1, RCC_CCIPR1_XSPI2SEL)))
...
#define IS_RCC_TIMPRES(__VALUE__)  \
  (((__VALUE__) == RCC_TIMPRES_DESACTIVATED) || \
   ((__VALUE__) == RCC_TIMPRES_ACTIVATED))
