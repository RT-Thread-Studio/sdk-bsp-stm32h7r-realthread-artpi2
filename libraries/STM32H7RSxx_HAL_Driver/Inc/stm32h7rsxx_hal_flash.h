...
#define FLASH_FLAG_ISR_ERRORS        (FLASH_FLAG_WRPERR     | FLASH_FLAG_PGSERR   | FLASH_FLAG_STRBERR | \
                                      ...
                                      FLASH_FLAG_SNECCERR   | FLASH_FLAG_DBECCERR | FLASH_FLAG_CRCERR)
#define FLASH_FLAG_OPTISR_ERRORS     (FLASH_FLAG_KVERR      | FLASH_FLAG_KTERR    | FLASH_FLAG_OPTERR)
#define FLASH_FLAG_ALL_ERRORS        (FLASH_FLAG_ISR_ERRORS | FLASH_FLAG_OPTISR_ERRORS)

#define FLASH_FLAG_ISR_FLAGS         (FLASH_FLAG_ISR_ERRORS | FLASH_FLAG_EOP)
/**
  * @}
  */
...
#define IS_OPTIONBYTE(VALUE)               (((VALUE) <= (OPTIONBYTE_WRP | OPTIONBYTE_USER | OPTIONBYTE_HDP | OPTIONBYTE_NV)))
