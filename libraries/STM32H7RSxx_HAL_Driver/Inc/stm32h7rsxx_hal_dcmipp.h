...
#define DCMIPP_OUTSTANDING_TRANSACTION_2    (0x01 << DCMIPP_IPC1R1_OTR_Pos) /*!< Two outstanding transactions         */
#define DCMIPP_OUTSTANDING_TRANSACTION_3    (0x02 << DCMIPP_IPC1R1_OTR_Pos) /*!< Three outstanding transactions       */
#define DCMIPP_OUTSTANDING_TRANSACTION_4    (0x03 << DCMIPP_IPC1R1_OTR_Pos) /*!< Four outstanding transactions        */
/**
  * @}
  */
...
#define IS_DCMIPP_DPREG_END(DPREG_END) ((DPREG_END) <= 0x1F)
#define IS_DCMIPP_DPREG_START(DPREG_START) ((DPREG_START) <= 0x1F)
...
#define IS_DCMIPP_WLRU_RATIO(WLRU_RATIO) ((WLRU_RATIO)<= 0xF)
...
#define IS_DCMIPP_PIPE_CROP_HSIZE(CROP_HSIZE)   ((CROP_HSIZE >= 1) && (CROP_HSIZE <= 0xFFF))
#define IS_DCMIPP_PIPE_CROP_HSTART(CROP_VSIZE)  ((CROP_VSIZE >= 1) && (CROP_VSIZE <= 0xFFF))
#define IS_DCMIPP_PIPE_CROP_VSIZE(CROP_VSTART)  ((CROP_VSTART >= 1) && (CROP_VSTART <= 0xFFF))
#define IS_DCMIPP_PIPE_CROP_VSTART(CROP_HSTART) ((CROP_HSTART >= 1) && (CROP_HSTART <= 0xFFF))
...
#define IS_DCMIPP_DATA_LIMIT(DATA_LIMIT) (((DATA_LIMIT) >=1 ) && ((DATA_LIMIT) <= 0xFFFFFF))
