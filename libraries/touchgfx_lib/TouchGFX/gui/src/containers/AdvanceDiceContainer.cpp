...
AdvanceDiceContainer::AdvanceDiceContainer() :
...
void AdvanceDiceContainer::initialize()
{
    AdvanceDiceContainerBase::initialize();
...
void AdvanceDiceContainer::handleTickEvent()
{
...
void AdvanceDiceContainer::left()
{
    animating = true;
    steps = 100;
    previousY = 0;
...
void AdvanceDiceContainer::right()
{
    animating = true;
    steps = 100;
    previousY = 0;
...
void AdvanceDiceContainer::down()
{
    animating = true;
    steps = 100;
    previousZ = 0;
...
void AdvanceDiceContainer::setScale(float value)
{
    for (int i = 0; i < NUMBER_OF_DICE_SIDES; i++)
    {
        diceSides[i].invalidateContent();
...
void AdvanceDiceContainer::reorderCube()
{
    for (int i = 0; i < NUMBER_OF_DICE_SIDES; i++)
    {
        remove(diceSides[i]);
...
void AdvanceDiceContainer::updateRightToLeft(TextureMapper& tm)
{
...
void AdvanceDiceContainer::updateLeftToRight(TextureMapper& tm)
{
...
void AdvanceDiceContainer::updateUpToDown(TextureMapper& tm)
{
...
void AdvanceDiceContainer::updateDownToUp(TextureMapper& tm)
{
    tm.updateZAngle(tm.getZAngle() + PI);
...
void AdvanceDiceContainer::resetCubeSidesAngles()
{
    for (int i = 0; i < NUMBER_OF_DICE_SIDES; i++)
    {
...
void AdvanceDiceContainer::setDiceSides(uint16_t leftFrontBitmap)
{
...
void AdvanceDiceContainer::enter3Dcube(float simpleDiceAngle)
{
    for (int i = 0; i < NUMBER_OF_DICE_SIDES; i++)
    {
        switch (i)
...
void AdvanceDiceContainer::exit3Dcube()
{
    steps = 100;
    previousY = 0;
    startValueY = 0;
...
bool AdvanceDiceContainer::getIsAnimating()
{
    return animating;
}

uint16_t AdvanceDiceContainer::getLeftFrontBitmapId()
{
    return cubeMap[LEFT_FRONT];
}

float AdvanceDiceContainer::getFrontBitmapAngle()
{
    return diceSides[0].getZAngle();
}

float AdvanceDiceContainer::floatBackEaseOut(float t, float b, float c, float d)
{
    float s = 1.70158f;
    t = t / d - 1;
...
float AdvanceDiceContainer::floatBackEaseIn(float t, float b, float c, float d)
{
    float s = 1.70158f;
    float postFix = t /= d;
...
float AdvanceDiceContainer::floatBackEaseInOut(float t, float b, float c, float d)
{
    float s = 1.70158f;
    if ((t /= d / 2) < 1)
    {
...
float AdvanceDiceContainer::easeNone(float t, float b, float c, float d)
{
    return c * t / d + b;
}

void AdvanceDiceContainer::invalidateDice()
{
    for (int i = 0; i < NUMBER_OF_DICE_SIDES; i++)
    {
        diceSides[i].invalidateContent();
