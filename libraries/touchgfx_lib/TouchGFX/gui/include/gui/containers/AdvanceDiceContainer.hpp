#ifndef ADVANCEDICECONTAINER_HPP
#define ADVANCEDICECONTAINER_HPP

#include <gui_generated/containers/AdvanceDiceContainerBase.hpp>
#include "touchgfx/widgets/TextureMapper.hpp"

class AdvanceDiceContainer : public AdvanceDiceContainerBase
{
public:
    AdvanceDiceContainer();
    virtual ~AdvanceDiceContainer() {}
...
#endif // ADVANCEDICECONTAINER_HPP
