...
static struct rt_memheap sys_psram_heap;
...
#endif
    //rt_system_heap_init((void *) PSRAM_HEAP_BEGIN, (void *) PSRAM_HEAP_END);
    //@TODO psram and sdram memheap
    //rt_memheap_init(&sys_psram_heap, "psram", (void *)PSRAM_HEAP_BEGIN, PSRAM_HEAP_SIZE);
